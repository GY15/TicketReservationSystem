    ...
    <div class="banner-holder">
        ...
        <div class="jumbotron banner-desc col-md-4 col-md-offset-4" style="z-index: 10">
            <div class="container text-center">
                <h1>淘 票</h1>
                <div class="loginPanel" style="margin-top: 80px">
                    <form class="form-horizontal" action="/login" method="POST" role="form">
                        <div class="form-group" style="margin-top: 50px">
                            ...
                            <div class="col-md-7">
                                <input type="text" class="form-control" name = 'login_email' id="login_email" value="" placeholder="请输入用户名">
                            </div>
                        </div>
                    ...
                    <form class="form-horizontal" action="/register" method="post" role="form">
                        <div class="form-group" style="margin-top: 30px">
                            ...
                            <div class="col-md-6 input-group" style="margin-left: 0px;left: 15px;">
                                <input type="text" class="form-control"  name="reg_email" id="reg_email" placeholder="请输入邮箱" style="width: 210px;">
                        ...
                        <div class="form-group" style="margin-top: 20px">
                            ...
                            <div class="col-md-7">
                                <input type="text" class="form-control" name="valid_word" id="valid_word" placeholder="点击从邮箱中获取验证码">
                            </div>
                        </div>
                ...
                <div class="col-md-12 errorMessage" style="margin-top: 20px;color: red;font-weight: 500;font-size: 20px" >
                </div>
            </div>
        </div>
    </div>
